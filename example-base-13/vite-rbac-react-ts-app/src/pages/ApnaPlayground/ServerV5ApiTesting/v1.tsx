...
const ServerV5ApiTestingV1 = () => {
  const handleClick = (uri: string = "items") =>
    apiRequest({ method: "get", url: uri, baseURL: `${APIBaseURL}/api/v5` })
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-md text-center">
        <h1 className="text-2xl font-semibold text-gray-800 mb-4">API Testing V5</h1>
        <button
...
export default ServerV5ApiTestingV1;
