...
class TokenStorage {
  ...
  static #TOKEN_FILE_PATH = path.join(this.#TEMP_DIR, "token.v9.temp");
...
await ApiClient.getDataFromRoute("/user-dashboard");

await ApiClient.getDataFromRoute("/admin-dashboard");
