...
const API_BASE_URL = "http://localhost:3005/api/v9";
...
class ApiClient {
  static signup = async (name = "", email /** : string */, password /** : string */) => {
    try {
...
if (signUpRequired) {
  await ApiClient.signup("Admin1 Kumar", "admin1@example.com", "Test@123");
}

// Step 2: Log in and store token in a file, also this is conditional one.
if (loginRequired) {
  await ApiClient.login("admin1@example.com", "Test@123");
}
