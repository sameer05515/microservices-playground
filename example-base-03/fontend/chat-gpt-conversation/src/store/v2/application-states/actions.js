...
export const setDarkViewMode = () => ({
  type: ApplicationStateActions.SET_DARK_VIEW_MODE,
});
export const setLightViewMode = () => ({
  type: ApplicationStateActions.SET_LIGHT_VIEW_MODE,
});
