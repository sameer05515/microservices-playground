...
const resolvers = {
    ...
    Mutation: {
        upsertResume: async (_, { resume }) => {
            ...
            console.log('resumeResolvers : upsertResume Mutation : resume.uniqueId:', resume.uniqueId); // corrected console log
            ...
            console.log('resumeResolvers : upsertResume Mutation : resume :', JSON.stringify(resume));
