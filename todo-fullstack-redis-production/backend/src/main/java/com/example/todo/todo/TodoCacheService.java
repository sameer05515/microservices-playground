...
public class TodoCacheService {
    ...
    public TodoPageResponse get(String username,String search,Boolean completed,int page,int size,String sort){Object o=redis.opsForValue().get(key(username,search,completed,page,size,sort)); return o instanceof TodoPageResponse p?p:null;}
