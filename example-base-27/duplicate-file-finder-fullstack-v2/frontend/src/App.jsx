...
import {
 Alert,Box,Button,Card,CardContent,Checkbox,CircularProgress,Container,
...
function App(){
 ...
 const start=async()=>{
   ...
   try{const r=await axios.post(`${API}/duplicates/scan`,{rootPath:path.trim()});setJob({jobId:r.data.jobId,status:'QUEUED',percent:0,groups:[]});}
